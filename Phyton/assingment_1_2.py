...
def multiplayer(): # PART 2
    print("Assinment part 2".upper().center(50,"*"))
    print (" \n In this game you need to guess the number between 1 and 100 Generated by the computer")
    print (" \n When one of you get a wrong guess give the the other player will start ")
    ...
    while True:
        ...
        if turn == player1:
            ...
            if guess < randNum :
                ...
                print(f"CONGRATULATIONS!!! {player1} YOU  GOT IT.".ljust(40,emojize(":confetti_ball:")))
            ...
            if guess < randNum :
                ...
                print(f"CONGRATULATIONS!!! {player2} YOU  GOT IT.".ljust(40,emojize(":confetti_ball:")))
